      ...
      <div className="relative z-10">
        ...
        <section className="relative flex flex-col items-center justify-center py-24 px-6 text-center overflow-hidden">
          ...
          <div className="relative z-10 max-w-4xl mx-auto space-y-8">
            ...
            <p className="text-2xl md:text-4xl text-gray-300 tracking-wide font-nerko mt-8">
        ...
        <section className="py-24 px-6 relative">
          <div className="max-w-4xl mx-auto text-center space-y-16">
            ...
            <p className="text-5xl md:text-7xl text-white/90 leading-tight font-borel">
